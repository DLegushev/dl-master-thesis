...
if __name__ == '__main__':
    handler = Handler('./model/2d106det', 0, ctx_id=0, det_size=640)
    im = cv2.imread('/home/dl/1_study/0_BSU/master_thesis/dataset/emotions/base/jaffedbase/jaffedbase/KA.AN1.39.tiff')
    tim = im.copy()
